...
void ByteUtil::ByteArrCopy(const mbyte *d, int d_index, mbyte *t, int t_index, int length) {
...
void ByteUtil::intToBytes(int i, mbyte *b, int index) {
...
int ByteUtil::bytesToInt(mbyte *buf, int offset) {
    int i = 0;
...
void ByteUtil::longToBytes(mlong i, mbyte *b, int index) {
...
mlong ByteUtil::bytesToLong(mbyte *buf, int offset) {
    mlong i = 0;
